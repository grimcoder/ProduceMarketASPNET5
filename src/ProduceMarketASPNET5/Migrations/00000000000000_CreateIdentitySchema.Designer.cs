...
using ProduceMarketASPNET5.Models;

namespace ProduceMarketASPNET5.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("ProduceMarketASPNET5.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("ProduceMarketASPNET5.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
